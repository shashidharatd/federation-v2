...
# Override example
echo
run "kubectl patch federatedconfigmap web-file -n ${TEST_NS} --type=merge --patch '{\"spec\" : {\"overrides\": [{\"clusterName\" : \"cluster2\", \"clusterOverrides\": [{\"path\": \"/data/content\", \"value\" : \"Hello KubeCon Shanghai!\"}]}]}}'"
